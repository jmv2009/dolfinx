...
# Initialise logging
from dolfinx.common import (TimingType, git_commit_hash, has_debug, has_kahip, has_parmetis, has_petsc, list_timings,
                            timing)
...
__all__ = [
    ...
    "TimingType", "git_commit_hash", "has_debug", "has_kahip", "has_parmetis", "has_petsc", "list_timings",
    "timing"
]
